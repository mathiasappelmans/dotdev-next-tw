	...
	return (
		<div ref={ref} className="flex justify-between" >
			...
			<div className="relative flex flex-col -mt-6 mr-2 -ml-6">
				...
				{open && (
					<Link href="/Mathias_Appelmans_2025_v2.pdf" className="absolute z-50 top-10 sm:top-16 w-10 ml-3 sm:ml-8 sm:p-2 flex flex-col justify-center items-center gap-1 bg-opacity-20 bg-slate-900 px-2 py-1 rounded" target="_blank">
