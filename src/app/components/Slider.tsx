...
const Slider = ({ children }: { children: React.ReactNode }) => {
	...
	return (
		<>
			...
			<div className="flex flex-col justify-center items-center gap-6 text-xl mx-8 my-16 font-bold text-slate-900 animate-pulse">
				Find out more...
			</div>
			...
			<div
				...
				className='flex flex-col items-center mx-10 mt-52'
			>				
