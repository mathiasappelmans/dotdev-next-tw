    ...
    return (
        <>
            ...
            <div className="flex justify-center mb-6">
                <button
                    className=" hover:bg-slate-500 text-slate-700 font-semibold hover:text-white py-2 px-4 border border-slate-500 hover:border-transparent rounded animate-pulse"
